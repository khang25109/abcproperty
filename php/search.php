...
<?php
       ...
       $set = !empty($_POST['searchterm']) ? $_POST['searchterm'] : (!empty($_GET['searchterm']) ? $_GET['searchterm'] : null);
       if ($set) {
       $show = "SELECT * from property WHERE propertyName like '%$set%' OR description like '%$set%'";
